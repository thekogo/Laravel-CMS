...
@section('content')
    ...
    <div class="bg-white m-5 rounded-lg shadow-lg px-10 py-2">
        ...
        <div class="">
            ...
            {!! Form::text('title', $post->title, ['class' => 'block border w-full mt-2 px-3 py-2 rounded-md', 'placeholder' => 'หัวข้อ']) !!}
            @if ($errors->has('title'))
        ...
        <div class="">
            ...
            {!! Form::textarea('details', $post->details, ['class' => 'block border w-full mt-2 px-3 py-2 rounded-md', 'placeholder' => 'รายละเอียด']) !!}
