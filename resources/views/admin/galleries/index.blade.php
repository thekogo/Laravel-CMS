...
<div class="bg-navy pt-3">
    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
        <h3 class="font-bold pl-2">รูปภาพ</h3>
    </div>
</div>
<div class="bg-white m-5 rounded-lg shadow-lg px-5 py-2">
    ...
    <div class="flex justify-between mt-2">
        <h4 class="text-3xl font-medium">รูปภาพทั้งหมด</h4>
        <a href="{{ route('galleries.create') }}" class="px-7 py-2 mb-2 bg-green-300 font-semibold rounded-md">Create</a>
    </div>
    <br>
        ...
        <tbody>
            ...
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                ...
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                    ...
                    <a href="{{ route('galleries.edit', $gallery->id) }}" class="text-blue-400 hover:text-blue-600 underline">Edit</a>
